...
public class EmpMain {
	...
	public static void main(String[] args) {
		...
		InputExceptionCheck inputCheck = new InputExceptionCheck();
		...
		while (true) {
			...
			if (menu == 1) {
				...
				int empId = inputCheck.intTypeNumCHeck();
				System.out.print("성 입력: ");
				String lastName =  inputCheck.StringTypeCHeck();
				System.out.print("급여 입력: ");
				int salary = inputCheck.intTypeNumCHeck();
